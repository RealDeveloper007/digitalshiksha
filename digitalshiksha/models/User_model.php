...
class User_model extends CI_Model
{
    ...
    public function get_all_users()
    {
        ...
        // Order by user_from DESC (latest registered user first) - if user_from is NULL, it will be sorted first, then we can use user_id as fallback
        $this->db->order_by("users.user_from", "desc");
