...
$route['contact-us'] = "guest/contact_us";
$route['delete-account'] = "guest/delete_account";


$route['user_control/(:num)'] = "user_control/index/$1";
$route['message_control/(:num)'] = "message_control/index/$1";

$route['theme/dynamic_css'] = "theme/dynamic_css";
// Dashboard mocks routes - must come before frontend mock-test routes
$route['mocks/mock_test'] = "admin_control/view_my_mocks/mock_test";
$route['mocks/live_mock_test'] = "admin_control/view_my_mocks/live_mock_test";
$route['mocks/mock-test'] = "admin_control/view_my_mocks/mock_test";
$route['mocks/live-mock-test'] = "admin_control/view_my_mocks/live_mock_test";
$route['mocks/(:any)'] = "admin_control/view_my_mocks/$1";
// Frontend mock-test routes
$route['mock-test'] = "exam_control/view_all_mocks";
$route['mock-test-results'] = "exam_control/view_results";
