...
@media (max-width: 767px) {
    ...
    .change-box-s .form-group.rental_details > div {
        width: 100% !important;
    }
    .col-sm-3.filBtn {
        width: 100%;
    ...
    .col-sm-3.filBtn .btn:last-child {
        margin-right: 0;
    }
    ...
    .exam-list .caption .exam-title {
        font-size: 16px;
        line-height: 1.4;
        margin: 10px 0;
    }
    .exam-list .caption .exam-category {
        font-size: 12px;
    }
    .exam-list .showTime {
        margin: 10px 0;
