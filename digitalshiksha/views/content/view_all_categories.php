                ...
                <div class="tab-content">
                    <?php if (isset($categories) != NULL) { 
                        ...
                        foreach ($categories as $category) {
                            $category->exam_count = isset($mock_count[$category->category_id]) ? $mock_count[$category->category_id] : 0;
                        ...
                        // Sort by exam count (descending) - categories with more exams first
                                    ...
                                    <div class="category-item">
                                        ...
                                        <div class="category-info">
                                            <div class="category-info-item">
                                                ...
                                                <span class="exam-count"><?php echo $category->exam_count; ?></span>
                                            </div>
                                            <div class="category-info-item">
                                                <i class="fa fa-user"></i>
                                                <strong>Author:</strong>
                                                <span><?php echo $category->user_name; ?></span>
                                            </div>
                                        </div>
                                        <div class="category-actions">
                                            <a class="btn btn-primary" href="<?php echo base_url('admin_control/activate_category/' . $category->category_id); ?>" title="Activate">
                        ...
                        <div class="tab-pane fade active in" id="running">
                            <?php if (count($active_categories) > 0) {
                                foreach ($active_categories as $category) { ?>
                                    <div class="category-item">
                                        <div class="category-name">
                                            <a href="#" data-name="cat_name" data-type="text" data-url="<?php echo base_url('admin_control/update_category_name'); ?>" data-pk="<?=$category->category_id; ?>" class="data-modify-<?=$category->category_id; ?>"><?=$category->category_name; ?></a>
                                        </div>
                                        <div class="category-info">
                                            <div class="category-info-item">
                                                <i class="fa fa-file-text"></i>
                                        ...
                                        <div class="category-actions">
                                            <a class="btn btn-default modify" name="modify-<?=$category->category_id; ?>" href="#" title="Modify">
                                                <i class="glyphicon glyphicon-edit"></i>
                                            </a>
                                            <?php if($this->session->userdata('user_role_id')==1) { ?>
                                                <a class="btn btn-default" href="<?php echo base_url('admin_control/mute_category/' . $category->category_id); ?>" title="Deactivate" onclick="return confirm('Are you sure you want to deactivate this category?');">
                                                    <i class="glyphicon glyphicon-off"></i>
                                                </a>
                                                <a onclick="return delete_confirmation()" href="<?php echo base_url('admin_control/delete_category/' . $category->category_id); ?>" class="btn btn-default" title="Delete">
