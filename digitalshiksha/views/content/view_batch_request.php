...
<div class="batch-request-wrapper">
    <div class="batch-request-header">
        <h3><i class="fa fa-users"></i> Batch Request</h3>
    </div>
    ...
    <div class="batch-request-content">
                    ...
                    <div class="batch-card">
                        <div class="batch-info-grid">
                            <div class="batch-info-item">
                                <span class="batch-info-label"><i class="fa fa-calendar"></i> Date</span>
                                <span class="batch-info-value"><?= date('d M, Y', strtotime($result['created_at'])); ?></span>
                            </div>
                            
                            <div class="batch-info-item">
                                <span class="batch-info-label"><i class="fa fa-user-md"></i> Teacher</span>
                                <span class="batch-info-value"><?= $result['created_by']; ?></span>
                            </div>
                        ...
                        <?php if($result['status'] == 1) { ?>
                            <div class="batch-actions">
                                ...
                                <div class="btn-group">
                                    <a class="btn btn-success accept_batch" href="#" batchid="<?= $result['id']?>">
                                        <i class="fa fa-check"></i> Accept
                                    </a>
                                    <a class="btn btn-danger decline_request" href="#" batchid="<?= $result['id']?>">
                        ...
                        <?php } else { ?>
                            <div class="batch-actions">
                                <span class="batch-info-value"><?= $result['status']?></span>
                            </div>
                        <?php } ?>
                    </div>
                <?php 
        ...
        <?php } else { ?>
            <div class="no-data">
                ...
                <h4>No Batch Requests</h4>
                <p>You don't have any pending batch requests.</p>
            </div>
        <?php } ?>
    </div>
</div>
