...
<p style='text-align: center'>
		Please click on the below button for reset password.<br>
    <a style='cursor: pointer' href='<?= $url ?>'>
        <button style='background: #08c;border-color: #08c;color: #ffffff;padding: 10px 16px;font-size: 14.25px;line-height: 1.33;border-radius: 21px;font-weight: bold;cursor: pointer;'>Reset Password</button>
    </a>
</p>
