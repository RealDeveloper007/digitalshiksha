...
<div class="block category-form-wrapper">
    <div class="form-header">
        <h4><i class="fa fa-edit"></i> Edit Sub Sub-category</h4>
    </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="form-group">
                    ...
                    <?php echo form_dropdown('category', isset($option) ? $option : array(), isset($sub_sub_category->cat_id) ? $sub_sub_category->cat_id : '', 'id="category" class="form-control"') ?>
                </div>
                ...
                <div class="form-group">
                    ...
                    <?php echo form_dropdown('sub_category', isset($option2) ? $option2 : array('' => 'Select Sub Category'), isset($sub_sub_category->sub_cat_id) ? $sub_sub_category->sub_cat_id : '', 'id="sub_category" class="form-control"');?>
                </div>
                ...
                <div class="form-group">
                    ...
                    <?php echo form_input('sub_cat_name', isset($sub_sub_category->name) ? $sub_sub_category->name : '', 'id="sub_cat_name" placeholder="Enter sub sub-category name" class="form-control" required="required"') ?>
                </div>
