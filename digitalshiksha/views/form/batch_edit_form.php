...
<style>
    ...
    .batch-edit-wrapper .form-horizontal .form-group,
    .batch-edit-wrapper .form-group {
    ...
    @media (max-width: 767px) {
        ...
        select#status.form-control {
            padding: 5px 45px 14px 14px !important;
            width: 100% !important;
        }
...
<div class="batch-edit-wrapper">
    <div class="batch-edit-header">
        <h4><i class="fa fa-edit"></i> Edit Batch</h4>
    </div>
    ...
    <div class="batch-edit-content">
        ...
        <?php echo form_hidden('status_type', $status_type); ?>
        <?php echo form_hidden('id', $batch_details->id); ?>
        
        <div class="form-group">
            <label for="batch_name">
                Batch Name <span class="required">*</span>
            </label>
            <?php echo form_input('batch_name', $batch_details->batch_name, 'placeholder="Enter Batch Name" id="batch_name" class="form-control" required="required"') ?>
        </div>
        ...
        <div class="form-group">
            ...
            <?php echo form_input('batch_code', $batch_details->batch_code, 'placeholder="Enter Batch Code" id="batch_code" class="form-control" required="required"') ?>
        ...
        <div class="form-group">
            <label for="skill_input">
                <?= $label_name ?> <span class="required">*</span>
            </label>
            <?php echo form_input('students', '', 'id="skill_input" class="form-control" placeholder="Search and select students"') ?>
        ...
        <div class="form-group">
            ...
            <?php echo form_dropdown('status', ['In-Active','Active'], $batch_details->status, 'id="status" class="form-control"') ?>
        </div>
