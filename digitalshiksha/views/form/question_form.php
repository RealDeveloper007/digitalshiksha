...
function add_form(val) {
  //  alert(val);
    ...
    for (q = 1; q <= 4; q++) {
        ...
        opt += '<input type="hidden" name="new[' + q + ']" value="1" required="required">';
        if (val == 'Radio') {
...
function add_field() {
    ...
    if (i <= 8) {
        ...
        opt += '<input type="text" name="new[' + i + ']" value="1" required="required">';
    ...
    <div class="col-sm-12">
        ...
        <div class="row">
            ...
            <div class="answer-type-section">
                <label class="answer-type-label">
                    <i class="fa fa-check-circle"></i> Answer Type
                </label>
                <div class="answer-type-options">
                    <div class="answer-type-option">
                        <input type="radio" id="radio1" name="ans_type" required="required" value="Radio" onclick="add_form(this.value)">
                        <label for="radio1">
                            <i class="fa fa-dot-circle-o"></i> Single Choice (Radio)
                        </label>
                    </div>
                    <div class="answer-type-option">
                        <input type="radio" id="checkbox1" name="ans_type" required="required" value="Checkbox" onclick="add_form(this.value)">
                        <label for="checkbox1">
                            <i class="fa fa-check-square-o"></i> Multiple Choice (Checkbox)
                        </label>
                    </div>
                </div>
            </div>
