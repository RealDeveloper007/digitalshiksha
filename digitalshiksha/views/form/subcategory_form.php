...
<div class="block category-form-wrapper">
    <div class="form-header">
        <h4><i class="fa fa-plus-circle"></i> Create Sub-category</h4>
    </div>
            ...
            <div class="col-sm-12">
                ...
                <div class="form-group">
                    <label for="sub_cat_name">
                        <i class="fa fa-tag"></i> Sub-category Name <span class="required">*</span>
                    </label>
                    <?php echo form_input('sub_cat_name', '', 'id="sub_cat_name" placeholder="Enter sub-category name" class="form-control" required="required"') ?>
                </div>
