...
<div class="block">
    <div class="navbar block-inner block-header">
        <div class="row"><p class="text-muted">Edit FAQ </p></div>
    </div>
    <div class="block-content">
    <form action="<?php echo base_url('faqs/update/'.$faq->faq_id)?>" method="post" role="form" class="form-horizontal">  
    <div class="row">
    <div class="col-sm-12">
        <div class="row">
		  ...
		  <div class="form-group">
                ...
                <div class="col-lg-6 col-sm-8 col-xs-7 col-mb">
                    <div class="input-group">
                        <input type="text" name="faq_ques" id="faq_ques" class="form-control" style="width: 278%;" value="<?= $faq->faq_ques;?>" />
                    </div>
                </div>
            </div>
