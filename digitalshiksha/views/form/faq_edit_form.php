...
<div class="faq-form-wrapper">
    <div class="form-header">
        <h4><i class="fa fa-edit"></i> Edit FAQ</h4>
    ...
    <div class="form-body">
        ...
        <?= form_open(base_url('faqs/update/'.$faq->faq_id), 'method="post" role="form" class="form-horizontal"'); ?>
        
        <div class="form-group">
            <label for="faq_ques">
                <i class="fa fa-question-circle"></i> Question <span class="required">*</span>
            </label>
            <input type="text" name="faq_ques" id="faq_ques" class="form-control" value="<?= htmlspecialchars($faq->faq_ques); ?>" placeholder="Enter question" required="required" />
        </div>
