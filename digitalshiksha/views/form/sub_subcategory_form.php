...
<div class="block">
    ...
    <div class="col-sm-12">
        ...
        <div class="row">
            ...
            <div class="form-group">
                <label for="sub_cat_name" class="col-sm-offset-0 col-lg-2 col-xs-offset-1 col-xs-3 control-label mobile">Sub-Sub category Name:</label>
                <div class="col-lg-5 col-sm-8 col-xs-7 col-mb">
                    <?php echo form_input('sub_cat_name', '', 'id="sub_cat_name" placeholder="Sub-Sub-category Name" class="form-control" required="required"') ?>
                </div>
            </div>
            <br/><hr/>
            <div class="row">
