...
<div class="notice-form-wrapper">
    <div class="form-header">
        <h4><i class="fa fa-plus-circle"></i> Add Notice</h4>
    ...
    <div class="form-body">
        ...
        <?= form_open(base_url().'noticeboard/save', 'method="post" id="ajax-form" role="form" class="form-horizontal"'); ?>
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                <input type="text" name="daterange" id="daterange" class="form-control" required="required"/>
