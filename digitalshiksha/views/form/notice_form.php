...
-->
			...
			<div class="form-group">
                <label for="status" class="col-sm-offset-0 col-lg-2 col-xs-offset-1 col-xs-3 control-label mobile">Type: </label>
                <div class="col-lg-6 col-sm-8 col-xs-7 col-mb">
                <select name="notice_type" id="notice_type" class="form-control">
                    <option value="1" selected="selected">Notice</option>
                    <option value="2">Breaking News</option>
                </select>
                </div>
            </div>
            <div class="form-group">
                <label for="Description" class="col-sm-offset-0 col-lg-2 col-xs-offset-1 col-xs-3 control-label mobile" style="padding-top: 50px;">Title : </label>
                <div class="col-lg-6 col-sm-8 col-xs-7 col-mb">
                  <?php 
                    $data = array(
                        'name'        => 'notice_title',
