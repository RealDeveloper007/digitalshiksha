...
<div class="syllabus-form-wrapper">
    <div class="form-header">
        <h4>
            <i class="fa fa-<?php echo ($_GET['type'] == 'pdf') ? 'file-pdf-o' : (($_GET['type'] == 'video') ? 'video-camera' : 'file-text-o'); ?>"></i>
            Add <?= strtoupper($_GET['type']) ?> Question
        </h4>
    ...
    <div class="form-body">
            <div class="row">
                ...
                <?= form_open(base_url() . 'syllabus_control/save_question', 'enctype="multipart/form-data" method="post" id="ajax-form" role="form" class="form-horizontal"'); ?>
                
                <?php echo form_hidden('cat_id', $_GET['id'], 'id="cat_id"'); ?>
                <?php echo form_hidden('type', $_GET['type'], ''); ?>
                    ...
                    <?php echo form_input('question', '', 'id="question" placeholder="Enter question" class="form-control" required="required"') ?>
                            </div>
                ...
                <?php } else if ($_GET['type'] == 'pdf') { ?>
                    ...
                    <div class="form-group">
                        <label for="pdf_file">
                            <i class="fa fa-file-pdf-o"></i> Upload PDF File <span class="required">*</span>
                        </label>
                        <input type="file" name="pdf_file" id="pdf_file" accept=".pdf" required="required">
                            </div>
                        <?php } else { ?>
                            <div class="form-group">
                        <label for="url">
                        ...
                        <?php echo form_input('url', '', 'id="url" placeholder="Enter YouTube video ID" class="form-control" required="required"') ?>
                            </div>
                        <?php } ?>
