...
<div class="block">
    ...
    <div class="col-sm-12">
        ...
        <div class="row">
            ...
            <div class="form-group">
                <label for="parent-category" class="col-sm-3 col-xs-3 control-label mobile">Select Category:</label>
            ...
            <?php if($mock->batch_id!=0) { ?>
                ...
                ?>
                <div class="form-group">
                    <label for="parent-category" class="col-sm-2 col-sm-offset-1 col-xs-3 control-label control-label mobile">Select Batch:</label>
                ...
                <div class="form-group">
                    <label for="parent-category" class="col-sm-2 col-sm-offset-1 col-xs-3 control-label control-label mobile">Start/End Date</label>
                    <div class="col-lg-3 col-sm-4 col-xs-4">
                        <input type="date" class="form-control" name="batch_start_date" value="<?= date('Y-m-d',strtotime($mock->batch_start_date))?>">
                    </div>
                     <div class="col-lg-3 col-sm-4 col-xs-4">
                        <input type="date" class="form-control" name="batch_end_date" value="<?= date('Y-m-d',strtotime($mock->batch_end_date))?>">
                    </div>
                </div>
            <?php } ?> 

            <div class="form-group">
                <label for="passing_score" class="col-sm-2 col-sm-offset-1 col-xs-3 control-label mobile">Slug:</label>
                <div class="col-sm-3 col-xs-9 col-mb">
                    <div class="input-group">
                      <?php echo form_input('slug', $mock->slug, 'id="slug" placeholder="Passing Score" class="form-control" required="required"') ?>
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                <label for="public" class="col-sm-2 col-sm-offset-1 col-xs-3 control-label mobile">Active:</label>
                <div class="col-sm-3 col-xs-6 col-mb">
            ...
            <div class="form-group">
                <label for="public" class="col-sm-2 col-sm-offset-1 col-xs-3 control-label mobile">Quiz Master:</label>
                <div class="col-sm-3 col-xs-6 col-mb">
