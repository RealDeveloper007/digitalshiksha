    ...
    <div class="col-sm-12">
        ...
        <div class="row">
            ...
            <?php if($exam_type == 'live_mock_test') { ?>
                ...
                <div class="form-group">
                    <label for="parent-category" class="col-sm-offset-0 col-lg-2 col-xs-offset-1 col-xs-3 control-label mobile">Select Batch:</label>
                    <div class="col-lg-3 col-sm-4 col-xs-4">
                        <?php echo form_dropdown('btach_id', $option1,'', 'id="parent-batch" class="form-control"') ?>
                    </div>
                </div>

                <div class="form-group">
                    <label for="parent-category" class="col-sm-offset-0 col-lg-2 col-xs-offset-1 col-xs-3 control-label mobile">Start/End Date</label>
                    <div class="col-lg-3 col-sm-4 col-xs-4">
                        <input type="date" class="form-control" name="batch_start_date" value="<?= date('Y-m-d')?>">
                    </div>
                     <div class="col-lg-3 col-sm-4 col-xs-4">
                        <input type="date" class="form-control" name="batch_end_date" value="<?= date('Y-m-d')?>">
                    </div>
                </div>
            <?php } ?>    
              <div class="form-group">
                <label for="public" class="col-sm-offset-0 col-lg-2 col-xs-offset-1 col-xs-3 control-label mobile">Slug:</label>
                <div class="col-sm-3 col-xs-6 col-mb">
                    <?php echo form_input('slug', '', 'id="slug" placeholder="Slug" class="form-control"') ?>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-lg-3 col-sm-4 col-xs-4">
                    <?php echo form_dropdown('category', $option,'', 'id="parent-category" class="form-control"') ?>
                </div>
                <div class="col-lg-3 col-sm-4 col-xs-4">
            ...
            <div class="form-group">
                <label for="public" class="col-sm-offset-0 col-lg-2 col-xs-offset-1 col-xs-3 control-label mobile">Quiz Master:</label>
                <div class="col-sm-3 col-xs-6 col-mb">
                    <?php echo form_input('created_byy', '', 'id="created_byy" placeholder="Quiz Master Name" class="form-control"') ?>
                </div>
            </div>
