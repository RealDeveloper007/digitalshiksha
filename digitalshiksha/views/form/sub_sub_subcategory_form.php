...
<div class="block">
    <div class="navbar block-inner block-header">
        <div class="row"><p class="text-muted">Create Sub Sub Sub-category </p></div>
    </div>
        ...
        <div class="row">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-5 col-sm-8 col-xs-7 col-mb">
                    <?php echo form_dropdown('cat_id', $option, $cat_id, 'id="category" class="form-control"') ?>
                </div>
            </div>
             <div class="form-group">
            ...
            <div class="form-group" id="media-choose">
                ...
                <div class="col-lg-5 col-sm-8 col-xs-7 col-mb">
                <img id="blah" src="<?= base_url('assets/images/nopreview.jpeg') ?>" alt="your image" style="width: 100px;"/>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-5 col-sm-8 col-xs-7 col-mb">
                    <?php echo form_input('name', '', 'id="sub_cat_name" placeholder="Sub Sub Sub-category Name" class="form-control" required="required"') ?>
                </div>
            </div>
