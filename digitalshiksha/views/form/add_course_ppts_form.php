...
<div class="block">
    ...
    <?=form_open_multipart(base_url('course/upload_course_ppts'), 'role="form" class="form-horizontal"'); ?>
    <div class="row">
    <div class="col-sm-12">
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="form-group">
                <label for="" class="col-sm-offset-0 col-lg-2 col-xs-offset-1 col-xs-3 control-label mobile">Presentation Title: </label>
                <div class="col-lg-5 col-sm-8 col-xs-7 col-mb">
                  <?php 
                    $data = array(
                        'name'        => 'ppt_title',
            ...
            <div class="form-group" id="media-choose">
                <label for="upload-media-file" class="col-sm-offset-0 col-lg-2 col-xs-offset-1 col-xs-3 control-label mobile">Choose ppt: </label>
                <div class="col-lg-5 col-sm-8 col-xs-7 col-mb">
                    <input type="file" id="media" name="media" style="margin-top:8px;">
                    <p class="help-block"><i class="glyphicon glyphicon-warning-sign"></i> Allowed types = ppt | pptx</p>
                </div>
            </div>
            <br/><hr/>
            <div class="row">
                <div class="col-xs-offset-1 col-xs-11 col-sm-offset-2 col-md-8">
                    ...
                    <span class="text-info invisible-on-md"> <i class="glyphicon glyphicon-bell"></i> Last Presentation? Click "Finish"!</span>
                </div>
            </div>
            <?=form_close();?>
        </div>
