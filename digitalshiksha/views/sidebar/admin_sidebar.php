...
<ul class="nav sidebar">
    ...
    <li><a href="#" class="sub <?=($active==9)?"active":'';?>"><i class="fa fa-group"></i> Batch Control</a>
        <ul>
...
<?php } ?>
   ...
   <li><a href="#" class="sub <?=($active==6)?"active":'';?>"><i class="fa fa-code-fork"></i> Categories</a>
    ...
    <?php } ?>
    <?php if ($this->session->userdata['user_role_id'] <=3) { ?>
    <li><a href="#" class="sub <?=($active==7)?"active":'';?>"><i class="fa fa-comment"> </i> Digi Search Engine</a>
        <ul>
    ...
    <li><a href="#" class="sub <?=($active==3)?"active":'';?>"><i class="fa fa-cogs"> </i> Admin Area</a>
        <ul>
            ...
            <li><a href="<?=base_url('noticeboard'); ?>" class="<?=($class==35)?"current":'';?>">Noticeboard</a></li>
 ...
 <?php if ($this->session->userdata['user_role_id'] == 5 || $this->session->userdata['user_role_id'] == 4) { ?>
                <li><a href="<?=base_url('message_control'); ?>" class="<?=($class==40 || $class==42)?"current":'';?>"><i class="fa fa-envelope"></i> Contact Help desk</a></li>    
<?php } ?>    
