         ...
         <?php } ?>
            ...
            <div class="panel-body">
                <div class="row">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-12">
                                            <p class="dashboard-text text-center">Mock Test</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-sm-3">
                        <a href="<?=base_url('admin_control/view_live_tests');?>">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-xs-12 text-center">
                                        ...
                                        <div class="col-xs-12">
                                            <p class="dashboard-text text-center">Pending Live Test (<?= $pending_live_tests ?>)</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
