...
class MathsCaptcha{
    ...
    public function getCaptcha(){
        ...
        <input type="text" name="_captcha_solution" value="" style="width:80px;height:40px !important;font-size:1em;border:0px;border:1px solid #ccc !important;text-align:center;" onclick="if(this.value=='-'){select()}" required>
