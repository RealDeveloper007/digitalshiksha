	...
	public function login_post()
    {
        ...
        if ($this->form_validation->run() === FALSE) 
		{
            ...
            // Check athentication
                ...
                if ($CheckLogin['status']) 
				{
					$CheckLogin['data']->login_access_url = base_url('login_access').'?user_email='.$this->input->post('user_email').'&user_pass='.$this->input->post('user_pass').'&role='.$CheckLogin['data']->user_role_id.'&type=andriod';
